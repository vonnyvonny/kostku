package com.ezraaudivano.kostku.geolocation;
...
public class geoActivity extends AppCompatActivity implements OnMapReadyCallback, PermissionsListener {
    ...
    private FloatingActionButton btnBackFab;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBackFab = findViewById(R.id.btnBack);
        ...
        btnBackFab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                finish();
            }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menugeo, menu);
        return true;
    }
        ...
        mapboxMap.setStyle(new Style.Builder().fromUri(styleOption),
                new Style.OnStyleLoaded() {
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        ...
                        initLayers(style);
                        destinationPosition = Point.fromLngLat(110.416183, -7.779324);
                        ...
                        options.title("KostKu");
                        options.position(new LatLng(-7.779324, 110.416183));
